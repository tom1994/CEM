...
-- 初始数据
INSERT INTO `sys_user` (`user_id`, `username`, `password`, `salt`, `email`, `mobile`, `status`, `dept_id`, `create_time`) VALUES ('1', 'admin', '1ae7a015fbb263f6c01c44718abacba68b7fa71cf988511ba09a2c9fcaac1653', 'YzcmCZNvbXocrsz9dm8e', 'root@cem.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO `schedule_job` (`bean_name`, `method_name`, `params`, `cron_expression`, `status`, `remark`, `create_time`) VALUES ('testTask', 'test', 'cem', '0 0/30 * * * ?', '0', '有参数测试', '2016-12-01 23:16:46');
