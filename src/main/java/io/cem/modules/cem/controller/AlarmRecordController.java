...
//		}
		...
		for(int i=0;i<probeList.size();i++){
			int service = probeList.get(i).getServiceType();
			int record = probeList.get(i).getRecordId();
			if(service==1||service==2||service==3){
				RecordPingEntity recordPing = recordPingService.queryObject(record);
				probeList.get(i).setPingDelay(recordPing.getDelay());
				probeList.get(i).setPingDelayStd(recordPing.getDelayStd());
				probeList.get(i).setPingDelayVar(recordPing.getDelayVar());
				probeList.get(i).setPingJitter(recordPing.getJitter());
				probeList.get(i).setPingJitterStd(recordPing.getJitterStd());
				probeList.get(i).setPingJitterVar(recordPing.getJitterVar());
				probeList.get(i).setPingLossRate(recordPing.getLossRate());
			}else if(service==4||service==5){
				RecordTracertEntity recordTracert = recordTracertService.queryObject(record);
				probeList.get(i).setTracertDelay(recordTracert.getDelay());
				probeList.get(i).setTracertDelayStd(recordTracert.getDelayStd());
				probeList.get(i).setTracertDelayVar(recordTracert.getDelayVar());
				probeList.get(i).setTracertJitter(recordTracert.getJitter());
				probeList.get(i).setTracertJitterStd(recordTracert.getJitterStd());
				probeList.get(i).setTracertJitterVar(recordTracert.getJitterVar());
				probeList.get(i).setTracertLossRate(recordTracert.getLossRate());
			}else if(service==10||service==11){
				RecordSlaEntity recordSla = recordSlaService.queryObject(record);
				probeList.get(i).setSlaDelay(recordSla.getDelay());
				probeList.get(i).setSlaGDelay(recordSla.getGDelay());
				probeList.get(i).setSlaRDelay(recordSla.getRDelay());
				probeList.get(i).setSlaDelayStd(recordSla.getDelayStd());
				probeList.get(i).setSlaGDelayStd(recordSla.getGDelayStd());
				probeList.get(i).setSlaRDelayStd(recordSla.getRDelayStd());
				probeList.get(i).setSlaDelayVar(recordSla.getDelayVar());
				probeList.get(i).setSlaGDelayVar(recordSla.getGDelayVar());
				probeList.get(i).setSlaRDelayVar(recordSla.getRDelayVar());
				probeList.get(i).setSlaJitter(recordSla.getJitter());
				probeList.get(i).setSlaGJitter(recordSla.getGJitter());
				probeList.get(i).setSlaRJitter(recordSla.getRJitter());
				probeList.get(i).setSlaJitterStd(recordSla.getJitterStd());
				probeList.get(i).setSlaGJitterStd(recordSla.getGJitterStd());
				probeList.get(i).setSlaRJitterStd(recordSla.getRJitterStd());
				probeList.get(i).setSlaJitterVar(recordSla.getJitterVar());
				probeList.get(i).setSlaGJitterVar(recordSla.getGJitterVar());
				probeList.get(i).setSlaRJitterVar(recordSla.getRJitterVar());
				probeList.get(i).setSlaLossRate(recordSla.getLossRate());
				probeList.get(i).setSlaGLossRate(recordSla.getGLossRate());
				probeList.get(i).setSlaRLossRate(recordSla.getRLossRate());
			}else if(service==12){
				RecordDnsEntity recordDns = recordDnsService.queryObject(record);
				probeList.get(i).setDnsDelay(recordDns.getDelay());
				probeList.get(i).setDnsSuccessRate(recordDns.getSuccessRate());
			}else if(service==13){
				RecordDhcpEntity recordDhcp = recordDhcpService.queryObject(record);
				probeList.get(i).setDhcpDelay(recordDhcp.getDelay());
				probeList.get(i).setDhcpSuccessRate(recordDhcp.getSuccessRate());
			}else if(service==14){
				RecordPppoeEntity recordPppoe = recordPppoeService.queryObject(record);
				probeList.get(i).setPppoeDelay(recordPppoe.getDelay());
				probeList.get(i).setPppoeDropRate(recordPppoe.getDropRate());
				probeList.get(i).setPppoeSuccessRate(recordPppoe.getSuccessRate());
			}else if(service==15){
				RecordRadiusEntity recordRadius = recordRadiusService.queryObject(record);
				probeList.get(i).setRadiusDelay(recordRadius.getDelay());
				probeList.get(i).setRadiusSuccessRate(recordRadius.getSuccessRate());
			}else if(service==20){
				RecordWebPageEntity recordWebPage = recordWebPageService.queryObject(record);
				probeList.get(i).setWebpageDnsDelay(recordWebPage.getDnsDelay());
				probeList.get(i).setWebpageConnDelay(recordWebPage.getConnDelay());
				probeList.get(i).setWebpageHeadbyteDelay(recordWebPage.getHeadbyteDelay());
				probeList.get(i).setWebpagePageFileDelay(recordWebPage.getPageFileDelay());
				probeList.get(i).setWebpageRedirectDelay(recordWebPage.getRedirectDelay());
				probeList.get(i).setWebpageAboveFoldDelay(recordWebPage.getAboveFoldDelay());
				probeList.get(i).setWebpagePageElementDelay(recordWebPage.getPageElementDelay());
				probeList.get(i).setWebpageLoadDelay(recordWebPage.getLoadDelay());
				probeList.get(i).setWebpageDownloadRate(recordWebPage.getDownloadRate());
			}else if(service==30){
				RecordWebDownloadEntity recordWebDownload = recordWebDownloadService.queryObject(record);
				probeList.get(i).setWebDownloadDnsDelay(recordWebDownload.getDnsDelay());
				probeList.get(i).setWebDownloadConnDelay(recordWebDownload.getConnDelay());
				probeList.get(i).setWebDownloadHeadbyteDelay(recordWebDownload.getHeadbyteDelay());
				probeList.get(i).setWebDownloadDownloadRate(recordWebDownload.getDownloadRate());
			}else if(service==31||service==32){
				RecordFtpEntity recordFtp = recordFtpService.queryObject(record);
				probeList.get(i).setFtpDnsDelay(recordFtp.getDnsDelay());
				probeList.get(i).setFtpConnDelay(recordFtp.getConnDelay());
				probeList.get(i).setFtpLoginDelay(recordFtp.getLoginDelay());
				probeList.get(i).setFtpHeadbyteDelay(recordFtp.getHeadbyteDelay());
				probeList.get(i).setFtpDownloadRate(recordFtp.getDownloadRate());
				probeList.get(i).setFtpUploadRate(recordFtp.getUploadRate());
			}else if(service==40){
				RecordWebVideoEntity recordWebVideo = recordWebVideoService.queryObject(record);
				probeList.get(i).setWebVideoDnsDelay(recordWebVideo.getDnsDelay());
				probeList.get(i).setWebVideoWsConnDelay(recordWebVideo.getWsConnDelay());
				probeList.get(i).setWebVideoWebPageDelay(recordWebVideo.getWebPageDelay());
				probeList.get(i).setWebVideoSsConnDelay(recordWebVideo.getSsConnDelay());
				probeList.get(i).setWebVideoAddressDelay(recordWebVideo.getAddressDelay());
				probeList.get(i).setWebVideoMsConnDelay(recordWebVideo.getMsConnDelay());
				probeList.get(i).setWebVideoHeadFrameDelay(recordWebVideo.getHeadFrameDelay());
				probeList.get(i).setWebVideoInitBufferDelay(recordWebVideo.getInitBufferDelay());
				probeList.get(i).setWebVideoLoadDelay(recordWebVideo.getLoadDelay());
				probeList.get(i).setWebVideoTotalBufferDelay(recordWebVideo.getTotalBufferDelay());
				probeList.get(i).setWebVideoDownloadRate(recordWebVideo.getDownloadRate());
				probeList.get(i).setWebVideoBufferTime(recordWebVideo.getBufferTime());
			}else if(service==50){
				RecordGameEntity recordGame = recordGameService.queryObject(record);
				probeList.get(i).setGameDnsDelay(recordGame.getDnsDelay());
				probeList.get(i).setGameConnDelay(recordGame.getConnDelay());
				probeList.get(i).setGamePacketDelay(recordGame.getPacketDelay());
				probeList.get(i).setGamePacketJitter(recordGame.getPacketJitter());
				probeList.get(i).setGameLossRate(recordGame.getLossRate());
