...
public class AllWeightController {
    ...
    public R settrTCP(String trt_new) {
        ...
        try {
            PropertiesUtils.setValue("trT11",trt_new_jsonobject.get("trT11").toString());
            PropertiesUtils.setValue("trT12",trt_new_jsonobject.get("trT12").toString());
            PropertiesUtils.setValue("trT13",trt_new_jsonobject.get("trT13").toString());
            PropertiesUtils.setValue("trT14",trt_new_jsonobject.get("trT14").toString());
            PropertiesUtils.setValue("trT15",trt_new_jsonobject.get("trT15").toString());
            PropertiesUtils.setValue("trT16",trt_new_jsonobject.get("trT16").toString());
            PropertiesUtils.setValue("trT17",trt_new_jsonobject.get("trT17").toString());
            PropertiesUtils.setValue("trT21",trt_new_jsonobject.get("trT21").toString());
            PropertiesUtils.setValue("trT22",trt_new_jsonobject.get("trT22").toString());
            PropertiesUtils.setValue("trT23",trt_new_jsonobject.get("trT23").toString());
            PropertiesUtils.setValue("trT24",trt_new_jsonobject.get("trT24").toString());
            PropertiesUtils.setValue("trT25",trt_new_jsonobject.get("trT25").toString());
            PropertiesUtils.setValue("trT26",trt_new_jsonobject.get("trT26").toString());
            PropertiesUtils.setValue("trT27",trt_new_jsonobject.get("trT27").toString());
            PropertiesUtils.setValue("trT31",trt_new_jsonobject.get("trT31").toString());
            PropertiesUtils.setValue("trT32",trt_new_jsonobject.get("trT32").toString());
            PropertiesUtils.setValue("trT33",trt_new_jsonobject.get("trT33").toString());
            PropertiesUtils.setValue("trT34",trt_new_jsonobject.get("trT34").toString());
            PropertiesUtils.setValue("trT35",trt_new_jsonobject.get("trT35").toString());
            PropertiesUtils.setValue("trT36",trt_new_jsonobject.get("trT36").toString());
            PropertiesUtils.setValue("trT37",trt_new_jsonobject.get("trT37").toString());
            PropertiesUtils.setValue("trT41",trt_new_jsonobject.get("trT41").toString());
            PropertiesUtils.setValue("trT42",trt_new_jsonobject.get("trT42").toString());
            PropertiesUtils.setValue("trT43",trt_new_jsonobject.get("trT43").toString());
            PropertiesUtils.setValue("trT44",trt_new_jsonobject.get("trT44").toString());
            PropertiesUtils.setValue("trT45",trt_new_jsonobject.get("trT45").toString());
            PropertiesUtils.setValue("trT46",trt_new_jsonobject.get("trT46").toString());
            PropertiesUtils.setValue("trT47",trt_new_jsonobject.get("trT47").toString());
            PropertiesUtils.setValue("trT51",trt_new_jsonobject.get("trT51").toString());
            PropertiesUtils.setValue("trT52",trt_new_jsonobject.get("trT52").toString());
            PropertiesUtils.setValue("trT53",trt_new_jsonobject.get("trT53").toString());
            PropertiesUtils.setValue("trT54",trt_new_jsonobject.get("trT54").toString());
            PropertiesUtils.setValue("trT55",trt_new_jsonobject.get("trT55").toString());
            PropertiesUtils.setValue("trT56",trt_new_jsonobject.get("trT56").toString());
            PropertiesUtils.setValue("trT57",trt_new_jsonobject.get("trT57").toString());
            PropertiesUtils.setValue("trT61",trt_new_jsonobject.get("trT61").toString());
            PropertiesUtils.setValue("trT62",trt_new_jsonobject.get("trT62").toString());
            PropertiesUtils.setValue("trT63",trt_new_jsonobject.get("trT63").toString());
            PropertiesUtils.setValue("trT64",trt_new_jsonobject.get("trT64").toString());
            PropertiesUtils.setValue("trT65",trt_new_jsonobject.get("trT65").toString());
            PropertiesUtils.setValue("trT66",trt_new_jsonobject.get("trT66").toString());
            PropertiesUtils.setValue("trT67",trt_new_jsonobject.get("trT67").toString());
            PropertiesUtils.setValue("trT71",trt_new_jsonobject.get("trT71").toString());
            PropertiesUtils.setValue("trT72",trt_new_jsonobject.get("trT72").toString());
            PropertiesUtils.setValue("trT73",trt_new_jsonobject.get("trT73").toString());
            PropertiesUtils.setValue("trT74",trt_new_jsonobject.get("trT74").toString());
            PropertiesUtils.setValue("trT75",trt_new_jsonobject.get("trT75").toString());
            PropertiesUtils.setValue("trT76",trt_new_jsonobject.get("trT76").toString());
            PropertiesUtils.setValue("trT77",trt_new_jsonobject.get("trT77").toString());
        } catch (IOException e) {
    ...
    public R setslaUDP(String su_new) {
        ...
        try {
            PropertiesUtils.setValue("slaU11",su_new_jsonobject.get("slaU11").toString());
            PropertiesUtils.setValue("slaU12",su_new_jsonobject.get("slaU12").toString());
            PropertiesUtils.setValue("slaU13",su_new_jsonobject.get("slaU13").toString());
            PropertiesUtils.setValue("slaU14",su_new_jsonobject.get("slaU14").toString());
            PropertiesUtils.setValue("slaU15",su_new_jsonobject.get("slaU15").toString());
            PropertiesUtils.setValue("slaU16",su_new_jsonobject.get("slaU16").toString());
            PropertiesUtils.setValue("slaU17",su_new_jsonobject.get("slaU17").toString());
            PropertiesUtils.setValue("slaU21",su_new_jsonobject.get("slaU21").toString());
            PropertiesUtils.setValue("slaU22",su_new_jsonobject.get("slaU22").toString());
            PropertiesUtils.setValue("slaU23",su_new_jsonobject.get("slaU23").toString());
            PropertiesUtils.setValue("slaU24",su_new_jsonobject.get("slaU24").toString());
            PropertiesUtils.setValue("slaU25",su_new_jsonobject.get("slaU25").toString());
            PropertiesUtils.setValue("slaU26",su_new_jsonobject.get("slaU26").toString());
            PropertiesUtils.setValue("slaU27",su_new_jsonobject.get("slaU27").toString());
            PropertiesUtils.setValue("slaU31",su_new_jsonobject.get("slaU31").toString());
            PropertiesUtils.setValue("slaU32",su_new_jsonobject.get("slaU32").toString());
            PropertiesUtils.setValue("slaU33",su_new_jsonobject.get("slaU33").toString());
            PropertiesUtils.setValue("slaU34",su_new_jsonobject.get("slaU34").toString());
            PropertiesUtils.setValue("slaU35",su_new_jsonobject.get("slaU35").toString());
            PropertiesUtils.setValue("slaU36",su_new_jsonobject.get("slaU36").toString());
            PropertiesUtils.setValue("slaU37",su_new_jsonobject.get("slaU37").toString());
            PropertiesUtils.setValue("slaU41",su_new_jsonobject.get("slaU41").toString());
            PropertiesUtils.setValue("slaU42",su_new_jsonobject.get("slaU42").toString());
            PropertiesUtils.setValue("slaU43",su_new_jsonobject.get("slaU43").toString());
            PropertiesUtils.setValue("slaU44",su_new_jsonobject.get("slaU44").toString());
            PropertiesUtils.setValue("slaU45",su_new_jsonobject.get("slaU45").toString());
            PropertiesUtils.setValue("slaU46",su_new_jsonobject.get("slaU46").toString());
            PropertiesUtils.setValue("slaU47",su_new_jsonobject.get("slaU47").toString());
            PropertiesUtils.setValue("slaU51",su_new_jsonobject.get("slaU51").toString());
            PropertiesUtils.setValue("slaU52",su_new_jsonobject.get("slaU52").toString());
            PropertiesUtils.setValue("slaU53",su_new_jsonobject.get("slaU53").toString());
            PropertiesUtils.setValue("slaU54",su_new_jsonobject.get("slaU54").toString());
            PropertiesUtils.setValue("slaU55",su_new_jsonobject.get("slaU55").toString());
            PropertiesUtils.setValue("slaU56",su_new_jsonobject.get("slaU56").toString());
            PropertiesUtils.setValue("slaU57",su_new_jsonobject.get("slaU57").toString());
            PropertiesUtils.setValue("slaU61",su_new_jsonobject.get("slaU61").toString());
            PropertiesUtils.setValue("slaU62",su_new_jsonobject.get("slaU62").toString());
            PropertiesUtils.setValue("slaU63",su_new_jsonobject.get("slaU63").toString());
            PropertiesUtils.setValue("slaU64",su_new_jsonobject.get("slaU64").toString());
            PropertiesUtils.setValue("slaU65",su_new_jsonobject.get("slaU65").toString());
            PropertiesUtils.setValue("slaU66",su_new_jsonobject.get("slaU66").toString());
            PropertiesUtils.setValue("slaU67",su_new_jsonobject.get("slaU67").toString());
            PropertiesUtils.setValue("slaU71",su_new_jsonobject.get("slaU71").toString());
            PropertiesUtils.setValue("slaU72",su_new_jsonobject.get("slaU72").toString());
            PropertiesUtils.setValue("slaU73",su_new_jsonobject.get("slaU73").toString());
            PropertiesUtils.setValue("slaU74",su_new_jsonobject.get("slaU74").toString());
            PropertiesUtils.setValue("slaU75",su_new_jsonobject.get("slaU75").toString());
            PropertiesUtils.setValue("slaU76",su_new_jsonobject.get("slaU76").toString());
            PropertiesUtils.setValue("slaU77",su_new_jsonobject.get("slaU77").toString());
            } catch (IOException e) {
