...
public class ProbeChartEntity {
    ...
    public boolean equals(Object obj) {
        ...
        if(this.getCountyId().equals(temp.getCountyId())&&this.getCityId().equals(temp.getCityId())&&end_time.equals(end_time1)&&this.getRecordTime().equals(temp.getRecordTime())){
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if(this.getCountyId()!=null&&this.getCityId()!=null&&this.getRecordTime()!=null&&this.getRecordDate()!=null)
            return this.countyId&this.cityId&this.recordTime.hashCode()&end_time.hashCode();
