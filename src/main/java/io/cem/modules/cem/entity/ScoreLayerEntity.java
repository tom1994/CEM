...
public class ScoreLayerEntity {
    ...
    public boolean equals(Object obj) {
        ScoreLayerEntity temp = (ScoreLayerEntity) obj;
        ...
        if (this.getAccessLayer().equals(temp.getAccessLayer())  && end_time.equals(end_time1) && this.getRecordTime().equals(temp.getRecordTime())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (this.getAccessLayer() != null && this.getRecordTime() != null && this.getRecordDate() != null)
            return this.getAccessLayer() & this.recordTime.hashCode() & end_time.hashCode();
