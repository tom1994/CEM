...
public class RecordHourDnsServiceImpl implements RecordHourDnsService {
	...
	@Override
	@Async
	public Future<List<RecordHourDnsEntity>> queryTargetHourList(Map<String, Object> map) {
		return new AsyncResult<>
				(recordHourDnsDao.queryTargetHourList(map));
	}
	...
	@Override
	@Async
	public Future<List<RecordHourDnsEntity>> queryDayExitList(Map<String, Object> map){
		return new AsyncResult<> (recordHourDnsDao.queryDayExitList(map));
	}
