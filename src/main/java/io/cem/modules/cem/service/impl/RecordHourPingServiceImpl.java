...
public class RecordHourPingServiceImpl implements RecordHourPingService {
	...
	@Override
	public List<ScoreEntity> calculateService1(List<RecordHourPingEntity> pingList, List<RecordHourTracertEntity> tracertList)  {
		...
		try {
			...
			List<ScoreEntity> tracertTcp = new ArrayList<>();
			for (int i = 0; i < pingList.size(); i++) {
				...
				if ((pingList.get(i).getServiceType()) == 1) {
					try {
						//delay 100
						if ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI22"))) <= 0) {
							score = 100 * (Double.parseDouble(pros.getValue("pingI21")));
						}
						//delay 80-100
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(PropertiesUtils.getValue("pingI22"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI23"))) <= 0)) {
						...
						//delay 60-80
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI23"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI24"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI24"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI25"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI25"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI26"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI26"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingI27"))) <= 0)) {
						...
						//delay_std 100
						if ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI32"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI31")));
						}
						//delay_std 80-100
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI32"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI33"))) <= 0)) {
						...
						//delay_std 60-80
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI33"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI34"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI34"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI35"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI35"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI36"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI36"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingI37"))) <= 0)) {
						...
						//delay_var 100
						if ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI42"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI41")));
						}
						//delay_var 80-100
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI42"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI43"))) <= 0)) {
						...
						//delay_var 60-80
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI43"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI44"))) <= 0)) {
						...
						//delay_var 40-60
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI44"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI45"))) <= 0)) {
						...
						//delay_var 20-40
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI45"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI46"))) <= 0)) {
						...
						//delay_var 0-20
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI46"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingI47"))) <= 0)) {
						...
						//jitter 100
						if ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI52"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI51")));
						}
						//jitter 80-100
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI52"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI53"))) <= 0)) {
						...
						//jitter 60-80
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI53"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI54"))) <= 0)) {
						...
						//jitter 40-60
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI54"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI55"))) <= 0)) {
						...
						//jitter 20-40
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI55"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI56"))) <= 0)) {
						...
						//jitter 0-20
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI56"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingI57"))) <= 0)) {
						...
						//jitter_std 100
						if ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI62"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI61")));
						}
						//jitter_std 80-100
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI62"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI63"))) <= 0)) {
						...
						//jitter_std 60-80
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI63"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI64"))) <= 0)) {
						...
						//jitter_std 40-60
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI64"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI65"))) <= 0)) {
						...
						//jitter_std 20-40
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI65"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI66"))) <= 0)) {
						...
						//jitter_std 0-20
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI66"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingI67"))) <= 0)) {
						...
						//jitter_var 100
						if ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI72"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI71")));
						}
						//jitter_var 80-100
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI72"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI73"))) <= 0)) {
						...
						//jitter_var 60-80
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI73"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI74"))) <= 0)) {
						...
						//jitter_var 40-60
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI74"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI75"))) <= 0)) {
						...
						//jitter_var 20-40
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI75"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI76"))) <= 0)) {
						...
						//jitter_var 0-20
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI76"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingI77"))) <= 0)) {
						...
						//loss 100
						if ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI82"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingI81")));
						}
						//loss 80-100
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI82"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI83"))) <= 0)) {
						...
						//loss 60-80
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI83"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI84"))) <= 0)) {
						...
						//loss 40-60
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI84"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI85"))) <= 0)) {
						...
						//loss 20-40
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI85"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI86"))) <= 0)) {
						...
						//loss 0-20
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI86"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingI87"))) <= 0)) {
				...
				//Ping(TCP)
				else if ((pingList.get(i).getServiceType()) == 2) {
					try {
						//delay 100
						if ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT22"))) <= 0) {
							score = 100 * (Double.parseDouble(pros.getValue("pingT21")));
						}
						//delay 80-100
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT22"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT23"))) <= 0)) {
						...
						//delay 60-80
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT23"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT24"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT24"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT25"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT25"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT26"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT26"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingT27"))) <= 0)) {
						...
						//delay_std 100
						if ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT32"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT31")));
						}
						//delay_std 80-100
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT32"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT33"))) <= 0)) {
						...
						//delay_std 60-80
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT33"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT34"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT34"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT35"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT35"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT36"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT36"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingT37"))) <= 0)) {
						...
						//delay_var 100
						if ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT42"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT41")));
						}
						//delay_var 80-100
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT42"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT43"))) <= 0)) {
						...
						//delay_var 60-80
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT43"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT44"))) <= 0)) {
						...
						//delay_var 40-60
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT44"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT45"))) <= 0)) {
						...
						//delay_var 20-40
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT45"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT46"))) <= 0)) {
						...
						//delay_var 0-20
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT46"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingT47"))) <= 0)) {
						...
						//jitter 100
						if ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT52"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT51")));
						}
						//jitter 80-100
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT52"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT53"))) <= 0)) {
						...
						//jitter 60-80
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT53"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT54"))) <= 0)) {
						...
						//jitter 40-60
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT54"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT55"))) <= 0)) {
						...
						//jitter 20-40
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT55"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT56"))) <= 0)) {
						...
						//jitter 0-20
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT56"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingT57"))) <= 0)) {
						...
						//jitter_std 100
						if ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT62"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT61")));
						}
						//jitter_std 80-100
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT62"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT63"))) <= 0)) {
						...
						//jitter_std 60-80
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT63"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT64"))) <= 0)) {
						...
						//jitter_std 40-60
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT64"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT65"))) <= 0)) {
						...
						//jitter_std 20-40
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT65"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT66"))) <= 0)) {
						...
						//jitter_std 0-20
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT66"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingT67"))) <= 0)) {
						...
						//jitter_var 100
						if ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT72"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT71")));
						}
						//jitter_var 80-100
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT72"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT73"))) <= 0)) {
						...
						//jitter_var 60-80
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT73"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT74"))) <= 0)) {
						...
						//jitter_var 40-60
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT74"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT75"))) <= 0)) {
						...
						//jitter_var 20-40
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT75"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT76"))) <= 0)) {
						...
						//jitter_var 0-20
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT76"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingT77"))) <= 0)) {
						...
						//loss 100
						if ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT82"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingT81")));
						}
						//loss 80-100
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT82"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT83"))) <= 0)) {
						...
						//loss 60-80
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT83"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT84"))) <= 0)) {
						...
						//loss 40-60
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT84"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT85"))) <= 0)) {
						...
						//loss 20-40
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT85"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT86"))) <= 0)) {
						...
						//loss 0-20
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT86"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingT87"))) <= 0)) {
				...
				//Ping(UDP)
				else if ((pingList.get(i).getServiceType()) == 3) {
					try {
						//delay 100
						if ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU22"))) <= 0) {
							score = 100 * (Double.parseDouble(pros.getValue("pingU21")));
						}
						//delay 80-100
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU22"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU23"))) <= 0)) {
						...
						//delay 60-80
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU23"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU24"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU24"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU25"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU25"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU26"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU26"))) > 0) && ((pingList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("pingU27"))) <= 0)) {
						...
						//delay_std 100
						if ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU32"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU31")));
						}
						//delay_std 80-100
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU32"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU33"))) <= 0)) {
						...
						//delay_std 60-80
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU33"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU34"))) <= 0)) {
						...
						//delay 40-60
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU34"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU35"))) <= 0)) {
						...
						//delay 20-40
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU35"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU36"))) <= 0)) {
						...
						//delay 0-20
						else if (((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU36"))) > 0) && ((pingList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("pingU37"))) <= 0)) {
						...
						//delay_var 100
						if ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU42"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU41")));
						}
						//delay_var 80-100
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU42"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU43"))) <= 0)) {
						...
						//delay_var 60-80
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU43"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU44"))) <= 0)) {
						...
						//delay_var 40-60
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU44"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU45"))) <= 0)) {
						...
						//delay_var 20-40
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU45"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU46"))) <= 0)) {
						...
						//delay_var 0-20
						else if (((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU46"))) > 0) && ((pingList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("pingU47"))) <= 0)) {
						...
						//jitter 100
						if ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU52"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU51")));
						}
						//jitter 80-100
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU52"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU53"))) <= 0)) {
						...
						//jitter 60-80
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU53"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU54"))) <= 0)) {
						...
						//jitter 40-60
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU54"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU55"))) <= 0)) {
						...
						//jitter 20-40
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU55"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU56"))) <= 0)) {
						...
						//jitter 0-20
						else if (((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU56"))) > 0) && ((pingList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("pingU57"))) <= 0)) {
						...
						//jitter_std 100
						if ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU62"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU61")));
						}
						//jitter_std 80-100
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU62"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU63"))) <= 0)) {
						...
						//jitter_std 60-80
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU63"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU64"))) <= 0)) {
						...
						//jitter_std 40-60
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU64"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU65"))) <= 0)) {
						...
						//jitter_std 20-40
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU65"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU66"))) <= 0)) {
						...
						//jitter_std 0-20
						else if (((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU66"))) > 0) && ((pingList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("pingU67"))) <= 0)) {
						...
						//jitter_var 100
						if ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU72"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU71")));
						}
						//jitter_var 80-100
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU72"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU73"))) <= 0)) {
						...
						//jitter_var 60-80
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU73"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU74"))) <= 0)) {
						...
						//jitter_var 40-60
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU74"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU75"))) <= 0)) {
						...
						//jitter_var 20-40
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU75"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU76"))) <= 0)) {
						...
						//jitter_var 0-20
						else if (((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU76"))) > 0) && ((pingList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("pingU77"))) <= 0)) {
						...
						//loss 100
						if ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU82"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("pingU81")));
						}
						//loss 80-100
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU82"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU83"))) <= 0)) {
						...
						//loss 60-80
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU83"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU84"))) <= 0)) {
						...
						//loss 40-60
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU84"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU85"))) <= 0)) {
						...
						//loss 20-40
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU85"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU86"))) <= 0)) {
						...
						//loss 0-20
						else if (((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU86"))) > 0) && ((pingList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("pingU87"))) <= 0)) {
			...
			for (int i = 0; i < tracertList.size(); i++) {
				...
				if ((tracertList.get(i).getServiceType()) == 4) {
					try {
						//delay 100
						if ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI12"))) <= 0) {
							score = 100 * (Double.parseDouble(pros.getValue("trI11")));
						}
						//delay 80-100
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI12"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI13"))) <= 0)) {
						...
						//delay 60-80
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI13"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI14"))) <= 0)) {
						...
						//delay 40-60
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI14"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI15"))) <= 0)) {
						...
						//delay 20-40
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI15"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI16"))) <= 0)) {
						...
						//delay 0-20
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI16"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trI17"))) <= 0)) {
						...
						//delay_std 100
						if ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI22"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI21")));
						}
						//delay_std 80-100
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI22"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI23"))) <= 0)) {
						...
						//delay_std 60-80
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI23"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI24"))) <= 0)) {
						...
						//delay 40-60
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI24"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI25"))) <= 0)) {
						...
						//delay 20-40
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI25"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI26"))) <= 0)) {
						...
						//delay 0-20
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI26"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trI27"))) <= 0)) {
						...
						//delay_var 100
						if ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI32"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI31")));
						}
						//delay_var 80-100
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI32"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI33"))) <= 0)) {
						...
						//delay_var 60-80
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI33"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI34"))) <= 0)) {
						...
						//delay_var 40-60
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI34"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI35"))) <= 0)) {
						...
						//delay_var 20-40
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI35"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI36"))) <= 0)) {
						...
						//delay_var 0-20
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI36"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trI37"))) <= 0)) {
						...
						//jitter 100
						if ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI42"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI41")));
						}
						//jitter 80-100
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI42"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI43"))) <= 0)) {
						...
						//jitter 60-80
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI43"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI44"))) <= 0)) {
						...
						//jitter 40-60
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI44"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI45"))) <= 0)) {
						...
						//jitter 20-40
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI45"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI46"))) <= 0)) {
						...
						//jitter 0-20
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI46"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trI47"))) <= 0)) {
						...
						//jitter_std 100
						if ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI52"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI51")));
						}
						//jitter_std 80-100
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI52"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI53"))) <= 0)) {
						...
						//jitter_std 60-80
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI53"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI54"))) <= 0)) {
						...
						//jitter_std 40-60
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI54"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI55"))) <= 0)) {
						...
						//jitter_std 20-40
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI55"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI56"))) <= 0)) {
						...
						//jitter_std 0-20
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI56"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trI57"))) <= 0)) {
						...
						//jitter_var 100
						if ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI62"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI61")));
						}
						//jitter_var 80-100
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI62"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI63"))) <= 0)) {
						...
						//jitter_var 60-80
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI63"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI64"))) <= 0)) {
						...
						//jitter_var 40-60
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI64"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI65"))) <= 0)) {
						...
						//jitter_var 20-40
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI65"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI66"))) <= 0)) {
						...
						//jitter_var 0-20
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI66"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trI67"))) <= 0)) {
						...
						//loss 100
						if ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI72"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trI71")));
						}
						//loss 80-100
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI72"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI73"))) <= 0)) {
						...
						//loss 60-80
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI73"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI74"))) <= 0)) {
						...
						//loss 40-60
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI74"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI75"))) <= 0)) {
						...
						//loss 20-40
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI75"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI76"))) <= 0)) {
						...
						//loss 0-20
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI76"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trI77"))) <= 0)) {
				...
				//TraceRoute(TCP)
				else if ((tracertList.get(i).getServiceType()) == 5) {
					try {
						//delay 100
						if ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT12"))) <= 0) {
							score = 100 * (Double.parseDouble(pros.getValue("trT11")));
						}
						//delay 80-100
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT12"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT13"))) <= 0)) {
						...
						//delay 60-80
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT13"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT14"))) <= 0)) {
						...
						//delay 40-60
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT14"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT15"))) <= 0)) {
						...
						//delay 20-40
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT15"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT16"))) <= 0)) {
						...
						//delay 0-20
						else if (((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT16"))) > 0) && ((tracertList.get(i).getDelay()).compareTo(new BigDecimal(pros.getValue("trT17"))) <= 0)) {
						...
						//delay_std 100
						if ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT22"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT21")));
						}
						//delay_std 80-100
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT22"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT23"))) <= 0)) {
						...
						//delay_std 60-80
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT23"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT24"))) <= 0)) {
						...
						//delay 40-60
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT24"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT25"))) <= 0)) {
						...
						//delay 20-40
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT25"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT26"))) <= 0)) {
						...
						//delay 0-20
						else if (((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT26"))) > 0) && ((tracertList.get(i).getDelayStd()).compareTo(new BigDecimal(pros.getValue("trT27"))) <= 0)) {
						...
						//delay_var 100
						if ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT32"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT31")));
						}
						//delay_var 80-100
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT32"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT33"))) <= 0)) {
						...
						//delay_var 60-80
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT33"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT34"))) <= 0)) {
						...
						//delay_var 40-60
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT34"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT35"))) <= 0)) {
						...
						//delay_var 20-40
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT35"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT36"))) <= 0)) {
						...
						//delay_var 0-20
						else if (((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT36"))) > 0) && ((tracertList.get(i).getDelayVar()).compareTo(new BigDecimal(pros.getValue("trT37"))) <= 0)) {
						...
						//jitter 100
						if ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT42"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT41")));
						}
						//jitter 80-100
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT42"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT43"))) <= 0)) {
						...
						//jitter 60-80
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT43"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT44"))) <= 0)) {
						...
						//jitter 40-60
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT44"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT45"))) <= 0)) {
						...
						//jitter 20-40
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT45"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT46"))) <= 0)) {
						...
						//jitter 0-20
						else if (((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT46"))) > 0) && ((tracertList.get(i).getJitter()).compareTo(new BigDecimal(pros.getValue("trT47"))) <= 0)) {
						...
						//jitter_std 100
						if ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT52"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT51")));
						}
						//jitter_std 80-100
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT52"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT53"))) <= 0)) {
						...
						//jitter_std 60-80
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT53"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT54"))) <= 0)) {
						...
						//jitter_std 40-60
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT54"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT55"))) <= 0)) {
						...
						//jitter_std 20-40
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT55"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT56"))) <= 0)) {
						...
						//jitter_std 0-20
						else if (((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT56"))) > 0) && ((tracertList.get(i).getJitterStd()).compareTo(new BigDecimal(pros.getValue("trT57"))) <= 0)) {
						...
						//jitter_var 100
						if ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT62"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT61")));
						}
						//jitter_var 80-100
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT62"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT63"))) <= 0)) {
						...
						//jitter_var 60-80
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT63"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT64"))) <= 0)) {
						...
						//jitter_var 40-60
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT64"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT65"))) <= 0)) {
						...
						//jitter_var 20-40
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT65"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT66"))) <= 0)) {
						...
						//jitter_var 0-20
						else if (((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT66"))) > 0) && ((tracertList.get(i).getJitterVar()).compareTo(new BigDecimal(pros.getValue("trT67"))) <= 0)) {
						...
						//loss 100
						if ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT72"))) <= 0) {
							score += 100 * (Double.parseDouble(pros.getValue("trT71")));
						}
						//loss 80-100
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT72"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT73"))) <= 0)) {
						...
						//loss 60-80
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT73"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT74"))) <= 0)) {
						...
						//loss 40-60
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT74"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT75"))) <= 0)) {
						...
						//loss 20-40
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT75"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT76"))) <= 0)) {
						...
						//loss 0-20
						else if (((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT76"))) > 0) && ((tracertList.get(i).getLossRate()).compareTo(new BigDecimal(pros.getValue("trT77"))) <= 0)) {
						...
						System.out.println("TraceRoute Tcp:"+score);
			...
			connection=putMap(tracertTcp,connection);
