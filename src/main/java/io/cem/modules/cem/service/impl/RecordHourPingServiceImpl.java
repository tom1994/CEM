...
public class RecordHourPingServiceImpl implements RecordHourPingService {
	...
	@Override
	//For quality rank page
	public List<ScoreEntity> calculateServiceDate1(List<RecordHourPingEntity> pingList, List<RecordHourTracertEntity> tracertList)  {
		List<ScoreEntity> connectionScore = new ArrayList<>();
		try {
			PropertiesUtils pros = new PropertiesUtils();
			...
			connection=putMapDate(tracertTcp,connection);
	...
	@Override
	//For quality rank page
	public List<ScoreEntity> calculateServiceArea1(List<RecordHourPingEntity> pingList, List<RecordHourTracertEntity> tracertList)  {
		List<ScoreEntity> connectionScore = new ArrayList<>();
		try {
			PropertiesUtils pros = new PropertiesUtils();
			...
			connection=putMapArea(tracertTcp,connection);
