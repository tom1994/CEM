...
public class RecordHourPingServiceImpl implements RecordHourPingService {
	...
	public List<ScoreEntity> dateChart1(List<ScoreEntity> scoreList){
		...
		for (int i = 0; i < scoreList.size(); i++) {
			...
			scoreBase.setTracertTcpDelay(scoreList.get(i).getTracertTcpDelay());
			scoreBase.setTracertTcpDelayStd(scoreList.get(i).getTracertTcpDelayStd());
			scoreBase.setTracertTcpDelayVar(scoreList.get(i).getTracertTcpDelayVar());
			scoreBase.setTracertTcpJitter(scoreList.get(i).getTracertTcpJitter());
			scoreBase.setTracertTcpJitterStd(scoreList.get(i).getTracertTcpJitterStd());
			scoreBase.setTracertTcpJitterVar(scoreList.get(i).getTracertTcpJitterVar());
			scoreBase.setTracertTcpLossRate(scoreList.get(i).getTracertTcpLossRate());
			...
			if (!connection.containsKey(dateChart)) {
				...
				scoreBase.setTracertTcpDelay(scoreBase.getTracertTcpDelay());
				scoreBase.setTracertTcpDelayStd(scoreBase.getTracertTcpDelayStd());
				scoreBase.setTracertTcpDelayVar(scoreBase.getTracertTcpDelayVar());
				scoreBase.setTracertTcpJitter(scoreBase.getTracertTcpJitter());
				scoreBase.setTracertTcpJitterStd(scoreBase.getTracertTcpJitterStd());
				scoreBase.setTracertTcpJitterVar(scoreBase.getTracertTcpJitterVar());
				scoreBase.setTracertTcpLossRate(scoreBase.getTracertTcpLossRate());
		...
		while (iterator.hasNext()) {
			...
			finalScore.setTracertTcpDelay(connection.get(ite).getTracertTcpDelay());
			finalScore.setTracertTcpDelayStd(connection.get(ite).getTracertTcpDelayStd());
			finalScore.setTracertTcpDelayVar(connection.get(ite).getTracertTcpDelayVar());
			finalScore.setTracertTcpJitter(connection.get(ite).getTracertTcpJitter());
			finalScore.setTracertTcpJitterStd(connection.get(ite).getTracertTcpJitterStd());
			finalScore.setTracertTcpJitterVar(connection.get(ite).getTracertTcpJitterVar());
			finalScore.setTracertTcpLossRate(connection.get(ite).getTracertTcpLossRate());
