...
public class IndexLineViewServiceImpl implements IndexLineViewService {
    ...
    public void saveConnectivityScore(List<Map<String,String>> mouths,String layerTag) throws ExecutionException, InterruptedException {
        ...
        for(Map<String,String> m : mouths){
            ...
            if(pingScores.size()>0){
                ...
                log.info("=========开始保存数据到表score_collect");
    ...
    public void saveWebPageScore(List<Map<String,String>> mouths,String layerTag) throws ExecutionException, InterruptedException {
        List<ScoreCollectEntity> scoreCollects = new LinkedList<ScoreCollectEntity>();
        Map<String,Object> param = new LinkedHashMap<String,Object>();
        for(Map<String,String> m : mouths){
    ...
    public void saveDownLoadScore(List<Map<String,String>> mouths,String layerTag) throws ExecutionException, InterruptedException {
        List<ScoreCollectEntity> scoreCollects = new LinkedList<ScoreCollectEntity>();
        Map<String,Object> param = new LinkedHashMap<String,Object>();
        for(Map<String,String> m : mouths){
            param.put("ava_start",m.get("startTime"));
    ...
    public void saveWebVideoScore(List<Map<String,String>> mouths,String layerTag) throws ExecutionException, InterruptedException {
        List<ScoreCollectEntity> scoreCollects = new LinkedList<ScoreCollectEntity>();
        Map<String,Object> param = new LinkedHashMap<String,Object>();
        for(Map<String,String> m : mouths){
            param.put("ava_start",m.get("startTime"));
            ...
            if(webVideoScores.size()>0){
                log.info("======================== WebVideoScore 开始更新数据表 ===");
                ScoreCollectEntity sce = new ScoreCollectEntity();
            ...
            log.info("======================== WebVideoScore 无数据更新 ==="+webVideoScores);

        }
    }


    public void saveGameScore(List<Map<String,String>> mouths,String layerTag) throws ExecutionException, InterruptedException {
