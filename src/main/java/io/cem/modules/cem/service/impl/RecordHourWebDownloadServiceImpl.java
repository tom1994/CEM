...
public class RecordHourWebDownloadServiceImpl implements RecordHourWebDownloadService {
	...
	@Override
	public List<ScoreEntity> calculateService4 (List<RecordHourWebDownloadEntity> webDownloadList, List<RecordHourFtpEntity> ftpList){
		...
		try {
			...
			for(int i=0;i<ftpList.size();i++){
				...
				//ftp Upload
				else if(ftpList.get(i).getServiceType()==32){
					//dns_delay 100
	...
	@Override
	public List<ScoreEntity> calculateServiceDate4 (List<RecordHourWebDownloadEntity> webDownloadList, List<RecordHourFtpEntity> ftpList){
		List<ScoreEntity> connectionScore = new ArrayList<>();
		RecordHourPingServiceImpl pingService = new RecordHourPingServiceImpl();
		try {
			PropertiesUtils pros = new PropertiesUtils();
	...
	@Override
	public List<ScoreEntity> calculateServiceArea4 (List<RecordHourWebDownloadEntity> webDownloadList, List<RecordHourFtpEntity> ftpList){
		List<ScoreEntity> connectionScore = new ArrayList<>();
		RecordHourPingServiceImpl pingService = new RecordHourPingServiceImpl();
		try {
			PropertiesUtils pros = new PropertiesUtils();
