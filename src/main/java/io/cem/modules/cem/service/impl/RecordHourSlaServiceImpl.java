...
public class RecordHourSlaServiceImpl implements RecordHourSlaService {
	...
	@Override
	public List<ScoreEntity> calculateServiceArea2(List<RecordHourSlaEntity> slaList, List<RecordHourDnsEntity> dnsList, List<RecordHourDhcpEntity> dhcpList, List<RecordHourPppoeEntity> pppoeList, List<RecordHourRadiusEntity> radiusList){
		List<ScoreEntity> connectionScore = new ArrayList<>();
		RecordHourPingServiceImpl pingService=new RecordHourPingServiceImpl();
		try {
			PropertiesUtils pros = new PropertiesUtils();
	...
	@Override
	public List<ScoreEntity> calculateServiceDate2(List<RecordHourSlaEntity> slaList, List<RecordHourDnsEntity> dnsList, List<RecordHourDhcpEntity> dhcpList, List<RecordHourPppoeEntity> pppoeList, List<RecordHourRadiusEntity> radiusList){
		List<ScoreEntity> connectionScore = new ArrayList<>();
		RecordHourPingServiceImpl pingService=new RecordHourPingServiceImpl();
		try {
			PropertiesUtils pros = new PropertiesUtils();
